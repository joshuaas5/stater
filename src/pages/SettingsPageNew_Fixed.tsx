        ...
        <div className="border-b border-gray-200 mb-6">
          <nav className="-mb-px flex space-x-8">
            ...
            <button
              ...
              className={`py-2 px-1 border-b-2 font-medium text-sm flex items-center bg-blue-500/100/10 px-4 rounded-t-lg ${
                activeTab === 'telegram'
              ...
              <div className="space-y-8">
                {isTelegramLinked ? (
                  ...
                  <div className="space-y-6">
                    <div className="flex items-center justify-center space-x-2 text-green-600 bg-green-500/100/10 p-4 rounded-lg">
                      <Check size={24} />
                      <span className="font-bold text-lg">Telegram conectado!</span>
                    </div>
                    
                    <div className="bg-green-500/100/10 border border-green-500/30 rounded-lg p-6">
                  ...
                  <div className="space-y-8">
                    <div className="text-center space-y-4">
                      ...
                      <div>
                        <h3 className="text-3xl font-bold text-gray-900 dark:text-white dark:text-white mb-2">
                    ...
                    <div className="bg-gradient-to-r from-blue-50 to-green-50 border border-blue-500/30 rounded-xl p-8">
