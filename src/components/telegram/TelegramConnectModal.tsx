...
// PaywallModal removido - Telegram livre para todos
...
export const TelegramConnectModal: React.FC<TelegramConnectModalProps> = ({
  ...
  const generateCode = async () => {
    ...
    // Bloqueio removido para testes. Usuário pode conectar livremente.
  ...
  return (
    <>
      <div
        className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 telegram-connect-modal"
        style={{ zIndex: 2147483648 }}
      >
        <div
          className="bg-white rounded-lg w-full max-w-sm max-h-[90vh] overflow-y-auto shadow-xl"
        ...
        >
          ...
          <div className="px-4 py-3 space-y-4">
            ...
            {error && (
              <div className="mt-4 text-sm text-red-600 bg-red-500/10 border border-red-500/30 rounded-md p-3">
                {error}
              </div>
            )}
      ...
      {/* PaywallModal removido completamente */}
    </>
  );
};
