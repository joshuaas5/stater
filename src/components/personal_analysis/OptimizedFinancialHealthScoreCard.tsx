// src/components/personal_analysis/OptimizedFinancialHealthScoreCard.tsx
...
const OptimizedFinancialHealthScoreCard: React.FC<FinancialHealthScoreCardProps> = memo(() => {
  ...
  const getScoreIcon = useMemo(() => (scoreType: 'savings' | 'debt' | 'liquidity', scoreValue: number) => {
        ...
        <ResponsiveContainer width="100%" height={450}>
          ...
          >
            ...
            <PolarRadiusAxis 
              ...
              tick={false} 
              axisLine={false} 
              label={{ angle: 90, position: 'insideStart' }}
            />
            <Radar
              name="Pontuação"
              dataKey="score"
...
OptimizedFinancialHealthScoreCard.displayName = 'OptimizedFinancialHealthScoreCard';

export default OptimizedFinancialHealthScoreCard;
