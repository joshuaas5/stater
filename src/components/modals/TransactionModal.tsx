              ...
              <div className="space-y-3 mt-3">
                <div>
                  ...
                  <select
                    ...
                    disabled={isSubmitting}
                  >
                    <option value="weekly" style={{ background: '#020617', color: 'white' }}>Semanal</option>
                    <option value="monthly" style={{ background: '#020617', color: 'white' }}>Mensal</option>
                    <option value="yearly" style={{ background: '#020617', color: 'white' }}>Anual</option>
                  </select>
                </div>
                ...
                {formData.recurrenceFrequency === 'weekly' && (
                  <div>
                    ...
                    <select
                      ...
                      disabled={isSubmitting}
                    >
                      <option value={0} style={{ background: '#020617', color: 'white' }}>Domingo</option>
                      <option value={1} style={{ background: '#020617', color: 'white' }}>Segunda-feira</option>
                      <option value={2} style={{ background: '#020617', color: 'white' }}>Terça-feira</option>
                      <option value={3} style={{ background: '#020617', color: 'white' }}>Quarta-feira</option>
                      <option value={4} style={{ background: '#020617', color: 'white' }}>Quinta-feira</option>
                      <option value={5} style={{ background: '#020617', color: 'white' }}>Sexta-feira</option>
                      <option value={6} style={{ background: '#020617', color: 'white' }}>Sábado</option>
                    </select>
                  </div>
                )}
                  ...
                  <div>
                    ...
                    >
                      {Array.from({ length: 31 }, (_, i) => (
                        <option key={i + 1} value={i + 1} style={{ background: '#020617', color: 'white' }}>
                          Dia {i + 1}
                        </option>
                      ))}
                    </select>
                ...
                {formData.recurrenceFrequency === 'yearly' && (
                  <div>
                    ...
                    <select
                      ...
                      disabled={isSubmitting}
                    >
                      <option value={1} style={{ background: '#020617', color: 'white' }}>Janeiro</option>
                      <option value={2} style={{ background: '#020617', color: 'white' }}>Fevereiro</option>
                      <option value={3} style={{ background: '#020617', color: 'white' }}>Março</option>
                      <option value={4} style={{ background: '#020617', color: 'white' }}>Abril</option>
                      <option value={5} style={{ background: '#020617', color: 'white' }}>Maio</option>
                      <option value={6} style={{ background: '#020617', color: 'white' }}>Junho</option>
                      <option value={7} style={{ background: '#020617', color: 'white' }}>Julho</option>
                      <option value={8} style={{ background: '#020617', color: 'white' }}>Agosto</option>
                      <option value={9} style={{ background: '#020617', color: 'white' }}>Setembro</option>
                      <option value={10} style={{ background: '#020617', color: 'white' }}>Outubro</option>
                      <option value={11} style={{ background: '#020617', color: 'white' }}>Novembro</option>
                      <option value={12} style={{ background: '#020617', color: 'white' }}>Dezembro</option>
                    </select>
                  </div>
                )}
