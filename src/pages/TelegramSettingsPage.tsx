...
const TelegramSettingsPage: React.FC = () => {
  ...
  const generateLinkCode = async () => {
    // Abrir modal diretamente sem verificação de plano (removido temporariamente)
    if (!user?.id) return;
  ...
  return (
    <div className="min-h-screen relative overflow-x-hidden overflow-y-auto pb-20 bg-[#0f172a] lg:bg-transparent safe-area-top">
