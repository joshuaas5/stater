...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //  KEYBOARD LAYOUT - Ajuste do teclado para Stater IA
        ...
        // WebChromeClient para PWA features + PERMISSÕES
        webView.setWebChromeClient(new WebChromeClient() {
            ...
            //  PERMISSÕES AUTOMÁTICAS - Microfone e Câmera para Stater IA
            @Override
            public void onPermissionRequest(PermissionRequest request) {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                    String[] permissions = request.getResources();
                    boolean hasCameraOrMicrophone = false;
                    ...
                    for (String permission : permissions) {
                        if (PermissionRequest.RESOURCE_AUDIO_CAPTURE.equals(permission) ||
                            ...
                            hasCameraOrMicrophone = true;
                            break;
                        }
                    }
                    
                    if (hasCameraOrMicrophone) {
                        // Conceder permissões automaticamente para Stater IA
