...
const AddBillPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen relative overflow-x-hidden overflow-y-auto pb-32 bg-[#0f172a] lg:bg-transparent safe-area-top">
      {/* Header */}
                    ...
                    <FormItem className="flex flex-row items-center space-x-3 py-2 rounded-md">
                      <FormControl>
                        <Checkbox
                          ...
                          className="border-white/40 data-[state=checked]:bg-white data-[state=checked]:text-[#0f172a]"
                        />
                      </FormControl>
