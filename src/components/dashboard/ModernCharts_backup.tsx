...
const ModernCharts: React.FC = () => {
  ...
  // Gráfico de evolução simples e elegante
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-3 gap-4">
          <div className="bg-green-50 p-4 rounded-lg border border-green-200">
            <div className="text-green-700 font-semibold text-sm mb-1 flex items-center gap-2">
              <span>💰</span>
              Total Receitas
            </div>
          ...
          <div className="bg-red-50 p-4 rounded-lg border border-red-200">
            <div className="text-red-700 font-semibold text-sm mb-1 flex items-center gap-2">
              <span>💸</span>
              Total Despesas
            </div>
          ...
          <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
            <div className="text-blue-700 font-semibold text-sm mb-1 flex items-center gap-2">
              <span>⚖️</span>
              Saldo Total
            </div>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          ...
          <ResponsiveContainer width="100%" height={400}>
            <AreaChart data={monthlyData} margin={{ top: 20, right: 30, left: 20, bottom: 40 }}>
              <defs>
                <linearGradient id="incomeGradientSimple" x1="0" y1="0" x2="0" y2="1">
                  <stop offset="5%" stopColor="#10b981" stopOpacity={0.3}/>
                  <stop offset="95%" stopColor="#10b981" stopOpacity={0.1}/>
                </linearGradient>
                <linearGradient id="expenseGradientSimple" x1="0" y1="0" x2="0" y2="1">
              ...
              <Area 
                ...
                name="💸 Despesas"
                stroke="#ef4444" 
                fill="url(#expenseGradientSimple)"
                strokeWidth={3}
              />
            </AreaChart>
          </ResponsiveContainer>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-600">
              {(() => {
                ...
                return (
                  <>
                    <div>
                      <p>• <strong>{profitableMonths}</strong> meses com saldo positivo</p>
                      <p>• Receita média: <strong>R$ {(totalIncome / monthlyData.length).toLocaleString('pt-BR', {minimumFractionDigits: 2})}</strong></p>
                    </div>
                    <div>
                      <p>• Despesa média: <strong>R$ {(totalExpenses / monthlyData.length).toLocaleString('pt-BR', {minimumFractionDigits: 2})}</strong></p>
                      <p>• {totalIncome > totalExpenses ? 
                        `✅ Economia de R$ ${(totalIncome - totalExpenses).toLocaleString('pt-BR', {minimumFractionDigits: 2})}` :
                        `⚠️ Deficit de R$ ${(totalExpenses - totalIncome).toLocaleString('pt-BR', {minimumFractionDigits: 2})}`
                      }</p>
                    </div>
                  </>
                );
