...
const FinancialInsights: React.FC = () => {
  ...
  return (
    <Card className="relative overflow-hidden border border-border bg-card/90 backdrop-blur-xl shadow-lg">
        ...
        {isGenerating ? (
          <div className="flex items-center justify-center py-8">
            <div className="flex items-center gap-3">
              <div className="animate-spin w-6 h-6 border-2 border-muted-foreground/30 border-t-muted-foreground rounded-full"></div>
              <span className="text-muted-foreground">IA analisando seus dados...</span>
            </div>
          </div>
        ) : (
              ...
              return (
                ...
                >
                  <div className="flex items-start gap-3">
                    <div className={`${styles.iconColor || styles.textColor} mt-1`}>
                      {insight.icon}
                    </div>
