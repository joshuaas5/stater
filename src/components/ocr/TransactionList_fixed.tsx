  ...
  return (
    <div className="space-y-3">
      ...
      <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-3">
        ...
        {showScrollHint && (
          <div className="flex items-center justify-center text-xs text-blue-600 pt-2 border-t border-blue-500/30">
      ...
      {/* Container com scroll REAL - CORRIGIDO */}
      <div 
                ...
                {editingIndex === index && editData ? (
                  ...
                  <div className="flex justify-between items-start">
                    <div className="flex-1">
                      <div className="font-medium text-gray-900 dark:text-white dark:text-white">{transaction.description}</div>
