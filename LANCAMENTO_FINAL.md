...
Secret Key: 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
Webhook Secret: whsec_UARzWbBm837M409UOkOOoXOuoGuTamqf
```
...
Value: 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
```

**Secret 2:**
```
Name: STRIPE_WEBHOOK_SECRET
Value: whsec_UARzWbBm837M409UOkOOoXOuoGuTamqf
```
...
- Se não tiver interface, use CLI:
  ```bash
  supabase secrets set STRIPE_SECRET_KEY=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
  supabase secrets set STRIPE_WEBHOOK_SECRET=whsec_UARzWbBm837M409UOkOOoXOuoGuTamqf
  ```
