...
const SUPABASE_ANON_KEY = process.env.VITE_SUPABASE_ANON_KEY || 'YOUR_JWT_TOKEN';
...
- NUNCA mencione planos premium, assinaturas, pagamentos ou preços
...
- NUNCA diga que áudio ou voz não é suportado (É suportado)
- NUNCA diga que fotos/imagens não são suportadas (SÃO suportadas)
- NUNCA invente restrições que não existem
