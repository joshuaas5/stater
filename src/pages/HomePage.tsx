...
const HomePage: React.FC = () => {
  ...
  const screenshots = [
    { img: 'dashboard.webp', title: 'Visão Geral', desc: 'Tenha o controle total das suas finanças em uma única tela' },
    { img: 'insights.webp', title: 'Insights com IA', desc: 'Receba dicas personalizadas baseadas nos seus gastos reais' },
    { img: 'saude-financeira.webp', title: 'Saúde Financeira', desc: 'Acompanhe seu score, fundo de emergência e taxa de poupança' },
    { img: 'stater-ia.webp', title: 'Stater IA', desc: 'Converse com a inteligência artificial sobre suas finanças' },
    { img: 'importar-docs.webp', title: 'Importar Documentos', desc: 'Importe extratos OFX, PDFs e fotos de notas fiscais' },
    { img: 'metas.webp', title: 'Metas Financeiras', desc: 'Defina seus objetivos e acompanhe o progresso' },
    { img: 'recorrentes.webp', title: 'Gastos Recorrentes', desc: 'Configure uma vez e automatize seus gastos mensais' },
  ];
  ...
  return (
    <div className="min-h-[100dvh] bg-gradient-to-br from-[#0f172a] via-[#1e293b] to-[#0f172a] text-white overflow-x-hidden font-sans selection:bg-blue-500/30">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 sm:h-20 flex items-center justify-between">
          <Link to="/" className="flex items-center gap-3 group">
            <div className="relative">
              ...
              <img src="/stater-logo-96.webp" alt="Stater" className="relative w-9 h-9 sm:w-11 sm:h-11 rounded-xl shadow-lg" width="96" height="96" />
            </div>
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            <Link to="/ferramentas" className="hidden md:block text-white/60 hover:text-white text-sm font-medium transition-colors">
              Ferramentas
            </Link>
            <Link to="/blog" className="hidden md:block text-white/60 hover:text-white text-sm font-medium transition-colors">
              Blog
            </Link>
                  ...
                  <div className="relative mx-auto w-[180px] sm:w-[220px]">
                    <div className="bg-gradient-to-b from-slate-800 to-slate-900 rounded-[2.5rem] p-2 border border-white/10 shadow-2xl">
                      <div className="rounded-[2rem] overflow-hidden bg-slate-950">
                        <img 
                          src="/screenshots/modo-simples.webp" 
      ...
      {/* ========== FERRAMENTAS GRATUITAS - SEO ========== */}
      <section className="relative z-10 py-16 sm:py-24 px-4 sm:px-6">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 bg-gradient-to-r from-emerald-500/20 to-teal-500/20 border border-emerald-500/30 rounded-full px-4 py-1.5 mb-6">
              <Zap className="w-4 h-4 text-emerald-400" />
              <span className="text-emerald-300 text-sm font-medium">100% Gratuito</span>
            </div>
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4">
              Ferramentas <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-teal-400">Financeiras</span>
            </h2>
            <p className="text-white/50 text-lg max-w-2xl mx-auto">
              Calculadoras e simuladores para ajudar nas suas decisoes financeiras
            </p>
          </div>
          
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <Link to="/ferramentas/calculadora-juros-compostos" className="group">
              <div className="bg-white/5 border border-white/10 rounded-2xl p-6 hover:bg-white/10 hover:border-emerald-500/30 transition-all duration-300 hover:-translate-y-1">
                ...
                <h3 className="text-lg font-bold mb-2 group-hover:text-emerald-400 transition-colors">Calculadora de Juros Compostos</h3>
                <p className="text-white/50 text-sm">Simule quanto seu dinheiro pode render ao longo do tempo</p>
              </div>
            </Link>
            
            <Link to="/ferramentas/calculadora-cdi" className="group">
              <div className="bg-white/5 border border-white/10 rounded-2xl p-6 hover:bg-white/10 hover:border-purple-500/30 transition-all duration-300 hover:-translate-y-1">
                ...
                <h3 className="text-lg font-bold mb-2 group-hover:text-purple-400 transition-colors">Calculadora CDI / CDB</h3>
                <p className="text-white/50 text-sm">Compare rendimentos de CDB, LCI e LCA com calculo de IR</p>
              </div>
            </Link>
            
            <Link to="/ferramentas/conversor-cripto" className="group">
              <div className="bg-white/5 border border-white/10 rounded-2xl p-6 hover:bg-white/10 hover:border-orange-500/30 transition-all duration-300 hover:-translate-y-1">
                ...
                <h3 className="text-lg font-bold mb-2 group-hover:text-orange-400 transition-colors">Conversor de Criptomoedas</h3>
                <p className="text-white/50 text-sm">Cotacao em tempo real de Bitcoin, Ethereum, Solana e mais</p>
              </div>
            </Link>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-10">
            ...
            <div className="flex flex-col items-center md:items-start">
              <div className="flex items-center gap-3 mb-3">
                <img src="/stater-logo-96.webp" alt="Stater" className="w-10 h-10 rounded-xl shadow-lg" width="96" height="96" />
                <span 
          ...
          >
            <p className="text-white/30 text-xs">
              © 2026 Stater. Todos os direitos reservados.
            </p>
